...
const T = {
  en: {
    ...
    // Section 10
    s10Title: "10. Minors' Privacy",
    s10Para1: "Our website and products are not specifically directed to minors.",
    s10Para2: "We do not knowingly collect personal information from minors where parental or guardian consent is legally required.",
  ...
  ru: {
    ...
    s4Para1: "ZAAV G находится на Бали и принимает заказы от покупателей из разных стран. Для работы сайта, обработки платежей, коммуникации и международной доставки персональные данные могут обрабатываться поставщиками услуг, находящимися в Индонезии или других странах.",
    s4Para2: "В результате определённые персональные данные могут передаваться или обрабатываться за пределами страны проживания покупателя. Если применимое законодательство устанавливает специальные требования к международной передаче персональных данных, мы принимаем разумные меры для соблюдения таких требований.",
    ...
    s10Title: "10. Данные несовершеннолетних",
    s10Para1: "Наш сайт и товары не предназначены специально для несовершеннолетних.",
    s10Para2: "Мы сознательно не собираем персональную информацию несовершеннолетних в случаях, когда для такого сбора законодательством требуется согласие родителя или законного представителя.",
  ...
  return (
    <PublicShell>
      <div className="relative w-full min-h-screen bg-white font-sans text-neutral-900 overflow-x-hidden selection:bg-neutral-900 selection:text-white">
        ...
        {/* Content Section */}
        <div id="privacyContent" className="py-12 pb-8 px-6 md:px-10 lg:px-16 max-w-4xl mx-auto">
          <h1 className="text-4xl lg:text-6xl text-black font-semibold leading-[1.9]">{t.privacyTitleSmall}</h1>
