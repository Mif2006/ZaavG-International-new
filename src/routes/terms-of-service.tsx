  ...
  return (
    <PublicShell>
      <div className="relative w-full min-h-screen bg-white font-sans text-neutral-900 overflow-x-hidden selection:bg-neutral-900 selection:text-white">
        ...
        {/* Content Section */}
        <div id="termsContent" className="py-12 pb-8 px-6 md:px-10 lg:px-16 max-w-4xl mx-auto">
            <h1 className="text-4xl lg:text-6xl text-black font-semibold leading-[1.9]">{t.termsTitleSmall}</h1>
