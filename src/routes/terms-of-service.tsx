...
export const Route = createFileRoute("/terms-of-service")({
  head: () => ({
    meta: [
      { title: "Terms of Service — Win Win Silver" },
      {
        name: "description",
        content: "Win Win Silver Terms of Service. Read the rules and guidelines for using our website and purchasing our handcrafted jewelry.",
      },
      { property: "og:title", content: "Terms of Service — Win Win Silver" },
      { property: "og:description", content: "Win Win Silver Terms of Service. Read the rules and guidelines for using our website and purchasing our handcrafted jewelry." },
    ],
  }),
...
/* Translation Dictionary with Formal Definitions Clause */
const T: Record<
  Lang,
  {
    termsTitle: string;
...
> = {
  en: {
    ...
    termsIntroLine1: "Welcome to Win Win Silver.",
    termsIntroLine2: "These Terms of Service govern your use of the website and services operated by Win Win Silver (hereinafter referred to as 'Win Win Silver', 'we', 'us', or 'our').",
    termsIntroLine3: "By accessing our website or placing an order, you agree to these terms. Please read them carefully before using the site.",
    generalTitle: "1. Definitions & General Information",
    generalText1: "Win Win Silver is an independent jewelry brand creating handcrafted jewelry inspired by Bali, art, and personal meaning.",
    generalText2: "Throughout these Terms, 'you' or 'Customer' refers to any user, visitor, or purchaser of our website and products.",
    generalText3: "By using this website, you confirm that you are at least 18 years old or have permission from a parent or legal guardian. We reserve the right to update or modify these Terms at any time without prior notice.",
    productsTitle: "2. Products & Handmade Nature",
    productsText1: "All Win Win Silver jewelry is handcrafted.",
    ...
    ordersText2: "Win Win Silver reserves the right to:",
    ...
    paymentText2: "Win Win Silver does not store complete payment card information",
    ...
    shippingText3: "Win Win Silver is not responsible for delays caused by customs, shipping carriers, or circumstances beyond our control.",
    shippingText4: "Customers are responsible for providing accurate shipping information.",
    returnsTitle: "7. Returns & Exchanges",
    returnsText1: "Because many Win Win Silver pieces are handmade, limited edition, or made to order, all return and exchange requests are reviewed individually.",
    ...
    careText1: "Win Win Silver jewelry should be handled with care.",
    ...
    ipText2Line1: "Belongs to Win Win Silver and may not be copied, reproduced, distributed, or used without written permission.",
    ipText2Line2: "Unauthorized use of our content or designs is prohibited.",
    liabilityTitle: "10. Limitation of Liability",
    liabilityText1: "Win Win Silver shall not be liable for:",
  ...
  ru: {
    ...
    termsIntroLine1: "Добро пожаловать в Win Win Silver.",
    termsIntroLine2: "Эти Условия обслуживания регулируют использование веб-сайта и услуг, управляемых Win Win Silver (далее — «Win Win Silver», «мы», «нас» или «наш»).",
    termsIntroLine3: "Получая доступ к нашему веб-сайту или оформляя заказ, вы соглашаетесь с этими условиями. Пожалуйста, внимательно прочитайте их перед использованием сайта.",
    generalTitle: "1. Определения и общая информация",
    generalText1: "Win Win Silver — независимый ювелирный бренд, создающий украшения ручной работы, вдохновленные Бали, искусством и личным смыслом.",
    generalText2: "В рамках настоящих Условий под «вы» или «Клиент» понимается любой пользователь, посетитель или покупатель нашего веб-сайта и продукции.",
    generalText3: "Используя этот веб-сайт, вы подтверждаете, что вам исполнилось 18 лет или у вас есть разрешение от родителя или законного опекуна. Мы оставляем за собой право обновлять или изменять эти Условия в любое время без предварительного уведомления.",
    productsTitle: "2. Продукция и ручная работа",
    productsText1: "Все украшения Win Win Silver изготовлены вручную.",
    ...
    ordersText2: "Win Win Silver оставляет за собой право:",
    ...
    paymentText2: "Win Win Silver не хранит полную информацию о платежных картах",
    ...
    shippingText3: "Win Win Silver не несет ответственности за задержки, вызванные таможней, транспортными компаниями или обстоятельствами, не зависящими от нас.",
    shippingText4: "Клиенты несут ответственность за предоставление точной информации о доставке.",
    returnsTitle: "7. Возврат и обмен",
    returnsText1: "Поскольку многие изделия Win Win Silver изготовлены вручную, являются лимитированными или изготавливаются на заказ, все запросы на возврат и обмен рассматриваются индивидуально.",
    ...
    careText1: "К украшениям Win Win Silver следует относиться бережно.",
    ...
    ipText2Line1: "Принадлежит Win Win Silver и не может быть скопирован, воспроизведен, распространен или использован без письменного разрешения.",
    ...
    liabilityText1: "Win Win Silver не несет ответственности за:",
  ...
  id: {
    ...
    termsIntroLine1: "Selamat datang di Win Win Silver.",
    termsIntroLine2: "Syarat Layanan ini mengatur penggunaan website dan layanan yang dioperasikan oleh Win Win Silver (selanjutnya disebut sebagai 'Win Win Silver', 'kami', atau 'milik kami').",
    termsIntroLine3: "Dengan mengakses website kami atau melakukan pemesanan, Anda menyetujui syarat-syarat ini. Harap baca dengan cermat sebelum menggunakan situs.",
    generalTitle: "1. Definisi & Informasi Umum",
    generalText1: "Win Win Silver adalah merek perhiasan independen yang menciptakan perhiasan buatan tangan yang terinspirasi oleh Bali, seni, dan makna pribadi.",
    generalText2: "Sepanjang Syarat ini, 'Anda' atau 'Pelanggan' merujuk pada setiap pengguna, pengunjung, atau pembeli website dan produk kami.",
    generalText3: "Dengan menggunakan website ini, Anda mengonfirmasi bahwa Anda berusia minimal 18 tahun atau memiliki izin dari orang tua atau wali sah. Kami berhak untuk memperbarui atau mengubah Syarat ini kapan saja tanpa pemberitahuan sebelumnya.",
    productsTitle: "2. Produk & Sifat Buatan Tangan",
    productsText1: "Semua perhiasan Win Win Silver dibuat secara handmade.",
    ...
    ordersText2: "Win Win Silver berhak untuk:",
    ...
    paymentText2: "Win Win Silver tidak menyimpan informasi kartu pembayaran lengkap",
    ...
    shippingText3: "Win Win Silver tidak bertanggung jawab atas keterlambatan yang disebabkan oleh bea cukai, perusahaan pengiriman, atau keadaan di luar kendali kami.",
    ...
    returnsText1: "Karena banyak pieces Win Win Silver dibuat tangan, edisi terbatas, atau dibuat sesuai pesanan, semua permintaan pengembalian dan penukaran ditinjau secara individual.",
    ...
    careText1: "Perhiasan Win Win Silver harus ditangani dengan hati-hati.",
    ...
    ipText2Line1: "Milik Win Win Silver dan tidak boleh disalin, direproduksi, didistribusikan, atau digunakan tanpa izin tertulis.",
    ipText2Line2: "Penggunaan tidak sah atas konten atau desain kami dilarang.",
    liabilityTitle: "10. Pembatasan Tanggung Jawab",
    liabilityText1: "Win Win Silver tidak bertanggung jawab atas:",
    ...
    contactIntro: "Для pertanyaan apa pun mengenai Syarat ini, silakan hubungi kami:",
        ...
        <div id="termsContent" className="py-24 px-6 md:px-10 lg:px-16 max-w-4xl mx-auto">
          ...
          <div className="bg-[#f9f9f9] p-6 sm:p-8 rounded-xl my-10 space-y-4">
            ...
            <div className="text-base text-neutral-900 font-semibold leading-[1.9] mt-4">
              Win Win Silver<br />
              📩 <a href="mailto:winwinsilver.bali@gmail.com" className="text-[#008060] font-normal hover:underline">winwinsilver.bali@gmail.com</a><br />
              🌐 <a href="https://winwinsilverbali.com" target="_blank" rel="noopener noreferrer" className="text-[#008060] font-normal hover:underline">winwinsilverbali.com</a>
            </div>
          </div>
        </div>
