...
const T: Record<Lang, Dict> = {
  ...
  ru: {
    ...
    features: [
      { title: "Уникальный дизайн", text: ["Вдохновлены древними символами и тихой силой природы."] },
      { title: "Собственное производство", text: ["Наша дизайн-студия и мастерская находятся на Бали,", "где каждое украшение создаётся вручную."] },
      { title: "Ручная работа", text: ["Каждое изделие создаётся вручную балийскими мастерами."] },
    ],
    benefits: [
      { title: "Натуральные материалы", text: ["Мы используем серебро 925 пробы, золото 24 карата и натуральные камни."] },
      { title: "Гарантия качества", text: ["Каждое украшение проходит тщательный контроль качества перед отправкой."] },
      { title: "Доставка по всему миру", text: ["Мы отправляем украшения Zaav G в разные уголки мира."] },
    ],
  },
  id: {
