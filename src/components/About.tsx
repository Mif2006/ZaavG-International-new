...
const T: Record<Lang, { title: string; subtitle: string; story: string }> = {
  ...
  ru: {
    title: "Zaav G",
    subtitle: "Возвращение к себе. Украшения со смыслом, созданные стать частью вашей жизни.",
    story:
      "Меня зовут Елена. Zaav G родился на Бали — острове, который меняет взгляд на красоту, время и самого себя. Когда-то всё началось с одного украшения. Со временем это стало особым языком — способом выразить то, что не всегда можно передать словами. Сегодня украшения Zaav G создаются вручную на Бали, а пространства бренда находятся на Бали и в Москве. Их носят девушки в разных уголках мира. Но главное осталось неизменным — это украшения, которые не просто надевают, а чувствуют.",
  },
  id: {
    title: "Zaav G",
